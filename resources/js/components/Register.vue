<template>
    <div class="bg-white rounded-2xl shadow-xl border border-slate-100 overflow-hidden">
      <div class="px-8 py-10">
        <div class="text-center mb-8">
          ...
          <p class="mt-2 text-sm text-slate-500">Join the security operations team</p>
        </div>
  ...
  const register = async () => {
    ...
    try {
      ...
      // Assuming register returns token, if not we might need to login
      emit('registered', data.token);
    } catch (e) {
